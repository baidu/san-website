...
San 提供了一个官方的 CLI，用于快速搭建繁杂的脚手架。它为现代前端工作流提供了开箱即用的构建设置，只需要几分钟的时间就可以把一个全新的 San 项目运行起来，并且自带热重载、代码规范检查、生产环境可用的构建版本等实用功能。同时，它还拥有图形用户界面。详情可查阅 [San CLI 的文档](https://ecomfe.github.io/san-cli/)。
