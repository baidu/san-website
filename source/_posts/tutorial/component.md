...
通过 [native](../event/#native) 修饰符，可以给 **模板组件** 的根元素（如包含）挂载事件。
...
- `transitionCreate`：[动画控制器 Creator](../transition/#动画控制器-Creator) 执行异常
- `transitionEnter`：进入[动画控制器](../transition/#动画控制器)执行异常
- `transitionLeave`：离开[动画控制器](../transition/#动画控制器)执行异常
